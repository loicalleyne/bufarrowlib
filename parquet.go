...
// Parquet returns the Parquet schema derived from the Arrow schema.
...
func (msg *message) WriteParquetRecords(w io.Writer, records ...arrow.RecordBatch) error {
